...
def dashboard():
    ...
    clientes_all = [
        ...
        # Agrega más clientes para otros países según sea necesario
    ]
    ...
    lineas_all = [
        ...
        {'id': 21, 'nombre': 'PY-LINEA 1', 'pais': 'Paraguay'},
        {'id': 22, 'nombre': 'PY-LINEA 2', 'pais': 'Paraguay'}
        # Más líneas por país si necesario
    ]
